...
This is the central design idea, and most changes touch it. The API has 562 operations; hand-writing 562 commands does not converge, so coverage comes in three tiers that share one binary:
