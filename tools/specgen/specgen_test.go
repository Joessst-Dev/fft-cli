...
var _ = Describe("specgen", func() {
	...
	Describe("reading an operation", func() {
		...
		It("carries x-fft-permissions, which 323 of the 561 real spec's operations declare", func() {
	...
	Describe("the whole real spec", func() {
		It("loads, and every sample body it produces is valid JSON", func() {
			// The synthesizer is recursive over 2,255 schemas. "It terminates" and "what it
