...
- [references/discovery.md](references/discovery.md) — getting from a word the user said to
  a command, across all 561 operations.
...
- [references/components.md](references/components.md) — the components installed alongside
  ...
  yours.
- [references/templates.md](references/templates.md) — saving a request body and sending it
