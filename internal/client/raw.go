...
// The raw request path: how fft reaches the 466 operations the typed client does
// not have.
//
// oapi-codegen is filtered to eight tags, so it has a Go method for 95 of the
// API's 561 operations. Tier-2 and Tier-3 commands reach the rest by building the
