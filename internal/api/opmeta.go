...
// methods out of the API's 562 operations. Tier-2 and Tier-3 commands have to
// reach the other 467, and they cannot do it through a typed client that does not
// have them.
//
...
type Operation struct {
	...
	// none. 324 of the 562 operations declare them.
	Permissions []string
...
// init() — a `fft version` should not pay for a map of 562 entries it will not
// read.
...
// rows rather than a full matrix: this runs 562 times per suggestion.
